    ...
    <div className="min-h-screen relative flex items-center justify-center p-4 font-sans overflow-hidden bg-slate-900">
      ...
      <div className="bg-white/80 dark:bg-slate-900/80 backdrop-blur-xl border border-white/20 dark:border-slate-800/50 rounded-3xl shadow-2xl p-8 sm:p-10 w-full max-w-md space-y-8 animate-in fade-in zoom-in-95 duration-500 relative z-10">
        ...
        <div className="flex flex-col items-center text-center space-y-4">
          ...
          <div>
            <h1 className="text-2xl font-black text-slate-900 dark:text-white tracking-tight">DuckClaw</h1>
          ...
          <h2 className="text-sm font-semibold text-slate-600 dark:text-slate-300 flex items-center gap-2">
            ...
            Acceso consola de configuración
          </h2>
        </div>
        ...
        <div className="pt-2">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 gap-3">
            <button
              type="button"
              onClick={() => {
                setEmail('viewer@duckclaw.local');
                setPassword('DuckView2026!');
              }}
            ...
            <button
              type="button"
              onClick={() => {
                setEmail('admin@duckclaw.local');
                setPassword('DuckAdmin2026!');
              }}
            ...
            >
              ...
              <span className="text-[10px] text-slate-500 mt-0.5">CRUD completo</span>
            </button>
          </div>
        </div>
        ...
        <div className="pt-6 text-center">
          <p className="text-[10px] text-slate-400 dark:text-slate-500 font-medium">
            DuckClaw · admin@duckclaw.local / viewer@duckclaw.local
          </p>
        </div>
      </div>
    </div>
